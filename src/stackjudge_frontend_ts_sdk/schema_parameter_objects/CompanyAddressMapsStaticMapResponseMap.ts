...
*/
export class CompanyAddressMapsStaticMapResponseMap
{
    public constructor(
        private key: string,
        private value: valueObject.StaticMapResponse,
    ) {
    }
    ...
    public toAngularHttpParams(): HttpParams
    {
        ...
        return new HttpParams()
            ...
            .set("value", this.value.toSdkString()) //#/components/schemas/StaticMapResponse
        ;
    }
